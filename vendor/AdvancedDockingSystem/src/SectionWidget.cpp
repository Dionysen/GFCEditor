    ...
    , _mousePressTitleWidget(NULL)
{
    ...
    _tabsMenuButton->setMaximumWidth(_tabsMenuButton->height());
...
QPushButton* SectionWidget::getTabsMenuButton() const
{
    return _tabsMenuButton;
}

QPushButton* SectionWidget::getCloseButton() const
{
    return _closeButton;
}
...
SectionWidgetTabsScrollArea::SectionWidgetTabsScrollArea(SectionWidget*, QWidget* parent)
    : QScrollArea(parent)
{
